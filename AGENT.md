...
2. **Браузер** ([methods/02-browser.md](methods/02-browser.md)) — архив контента и скачивание своих постов/Reels для базы; то, чего нет в API. Читай этот файл, когда человек хочет собрать/скачать контент.
3. **Телефон** ([methods/03-phone.md](methods/03-phone.md)) — **самая глубокая статистика**: удержание Reels по секундам, точки отвала аудитории. Этого нет нигде, кроме приложения. Читай этот файл, когда человек хочет глубину для разбора сценариев.

Сначала спроси человека, что ему нужно: «базовая аналитика», «скачать/собрать контент» или «глубокая статистика удержания». Под ответ выбери методы. Обзор: [methods/README.md](methods/README.md).
